...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13|GPIO_PIN_2, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|OSD_CS_Pin|GPIO_PIN_9, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PB0 OSD_CS_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_0|OSD_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
